<!-- Modal -->
<div class="modal fade" id="editModal{{$department->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'PATCH', 'url' => "departments/{$department->id}"]) !!}
